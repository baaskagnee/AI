...
class CardGameApp:
    ...
    def play_card(self):
        ...
        # Compare the highest cards in both hands
            ...
            if (all(VALUES[self.selected_cards[i].value] > VALUES[self.table.played_cards[i].value] for i in range(len(self.selected_cards)))or (all(VALUES[self.selected_cards[i].value] == VALUES[self.table.played_cards[i].value] for i in range(len(self.selected_cards)))and all(SUITS [self.selected_cards[i].suit] > SUITS [self.table.played_cards[i].suit] for i in range(len(self.selected_cards))))):
