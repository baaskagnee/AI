...
class Table:
    ...
    def place_card(self, player, card):
        """Өмнөх тоглолтуудыг арилгахгүйгээр тоглогчийн гараас авсан картыг ширээн дээр тавьдаг."""
    ...
    def start_new_round(self):
        """Шинэ тойргийн эхэнд хөзөр тоглосон."""
        self.played_cards.clear()

    def show_played_cards(self):
        """Ширээн дээр тоглож буй картуудыг харуулна."""
        if not self.played_cards:
            return "No cards have been played yet."
        return ', '.join(map(str, self.played_cards))

    def reset_table(self):
        """Ширээн дээрээс тоглосон хөзрийг арилгана."""
        self.played_cards.clear()
